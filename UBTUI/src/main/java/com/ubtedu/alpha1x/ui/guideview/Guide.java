package com.ubtedu.alpha1x.ui.guideview;
...
/**
 * 遮罩系统的封装 <br>
 * 外部需要调用{@link com.ubtedu.alpha1x.ui.guideview.GuideBuilder}来创建该实例，实例创建后调用
...
public class Guide implements View.OnKeyListener, View.OnClickListener {
   ...
   *
   * @see com.ubtedu.alpha1x.ui.guideview.GuideBuilder
   */
  Guide() {
  }
  ...
  /**
   * 显示该遮罩, <br>
   * 外部借助{@link com.ubtedu.alpha1x.ui.guideview.GuideBuilder}
