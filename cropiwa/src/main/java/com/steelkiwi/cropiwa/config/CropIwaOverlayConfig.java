...
public class CropIwaOverlayConfig {
    ...
    public static CropIwaOverlayConfig createFromAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            c.setDynamicCrop(ta.getBoolean(
                    ...
                    c.isDynamicCrop()));
            c.setDynamicCrop(ta.getBoolean(
                    R.styleable.CropIwaView_ci_calculate_from_width,
                    c.isCalculateFromWidth()));
        } finally {
            ta.recycle();
        }
        return c;
    ...
    private boolean isCalculateFromWidth;
    ...
    public boolean isCalculateFromWidth() {
        return isCalculateFromWidth;
    }

    public CropIwaOverlayConfig setCalculateFromWidth(boolean calculateFromWidth) {
        isCalculateFromWidth = calculateFromWidth;
        return this;
    }
