 ...
 * @Date 2019/06/19
 **/
public class URoUkitLegacyBoardUpgradeDataFormatter extends URoUkitLegacyCommandFormatter<URoUkitDummyData> {

    private URoUkitLegacyBoardUpgradeDataFormatter(){}

    public static final URoUkitLegacyBoardUpgradeDataFormatter INSTANCE = new URoUkitLegacyBoardUpgradeDataFormatter();
