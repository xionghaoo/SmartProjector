...
import com.ubtedu.base.utils.AppUtil;
import com.ubtedu.base.utils.MD5;
...
public class DiskCache implements ICache {
    ...
    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, FrameworkConfig.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, FrameworkConfig.CACHE_DISK_DIR)));
    }
