...
public interface Storage {
     ...
     * @param useAbsPath 指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     * @return <code>True</code> if directory was created, otherwise return
     * <code>False</code>
     * @throws StorageException
     */
    boolean createDirectory(String name, boolean useAbsPath);
     ...
     * @throws StorageException
     */
    boolean createDirectory(String name, boolean override, boolean useAbsPath);
     ...
     * <code>False</code>
     */
    boolean deleteDirectory(String name, boolean useAbsPath);
     ...
     */
    boolean isDirectoryExists(String name, boolean useAbsPath);
     ...
     * @param useAbsPath    指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     */
    boolean createFile(String directoryName, String fileName, String content, boolean useAbsPath);
     ...
     * @param useAbsPath    指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     */
    boolean createFile(String directoryName, String fileName, Storable storable, boolean useAbsPath);
     ...
     * @param useAbsPath    指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     */
    boolean createFile(String directoryName, String fileName, Bitmap bitmap, boolean useAbsPath);
     ...
     * @param useAbsPath    指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     */
    boolean createFile(String directoryName, String fileName, byte[] content, boolean useAbsPath);
     ...
     * @return
     */
    boolean deleteFile(String directoryName, String fileName, boolean useAbsPath);
     ...
     * @return
     */
    boolean isFileExist(String directoryName, String fileName, boolean useAbsPath);
     ...
     * @return
     */
    byte[] readFile(String directoryName, String fileName, boolean useAbsPath);
    byte[] readFile(String fileAbsPath);
    /**
     ...
     * @return
     */
    String readTextFile(String directoryName, String fileName, boolean useAbsPath);
     ...
     * @param useAbsPath    指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     */
    void appendFile(String directoryName, String fileName, String content, boolean useAbsPath);
     ...
     * @param useAbsPath    指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     */
    void appendFile(String directoryName, String fileName, byte[] bytes, boolean useAbsPath);
     ...
     * @param useAbsPath 指定目录是否使用绝对路径？ true是绝对路径，false是相对路径
     */
    List<File> getNestedFiles(String directoryName, boolean useAbsPath);
     ...
     */
    List<File> getFiles(String directoryName, String matchRegex, boolean useAbsPath);
     ...
     * @return
     */
    List<File> getFiles(String directoryName, OrderType orderType, boolean useAbsPath);
     ...
     * @return
     */
    File getFile(String name, boolean useAbsPath);
     ...
     * @return
     */
    File getFile(String directoryName, String fileName, boolean useAbsPath);
     ...
     *
     * @param sizeUnit The units you want the returned value to be.
     ...
     * @throws StorageException
     */
    boolean copy(File file, String directoryName, String fileName, boolean useAbsPath);
     ...
     * @throws StorageException
     */
    void move(File file, String directoryName, String fileName, boolean useAbsPath);
}
