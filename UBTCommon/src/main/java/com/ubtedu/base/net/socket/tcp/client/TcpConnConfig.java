...
import com.ubtedu.base.net.socket.tcp.client.helper.decode.AbsDecodeHelper;
import com.ubtedu.base.net.socket.tcp.client.helper.decode.BaseDecodeHelper;
import com.ubtedu.base.net.socket.tcp.client.helper.stickpackage.AbsStickPackageHelper;
import com.ubtedu.base.net.socket.tcp.client.helper.stickpackage.BaseStickPackageHelper;
import com.ubtedu.base.net.socket.tcp.client.helper.validation.AbsValidationHelper;
import com.ubtedu.base.net.socket.tcp.client.helper.validation.BaseValidationHelper;
import com.ubtedu.base.net.socket.utils.CharsetUtil;
import com.ubtedu.base.net.socket.utils.StringValidationUtils;
...
public class TcpConnConfig {
    ...
    public void setStickPackageHelper(AbsStickPackageHelper stickPackageHelper) {
        mStickPackageHelper = stickPackageHelper;
    }
    ...
    public static class Builder {
        ...
        public Builder setSoTimeout(long timeout){
