...
public class NetGlobalConfig {
    ...
    public NetGlobalConfig proxy(Proxy proxy) {
        RxNet.getOkHttpBuilder().proxy(checkNotNull(proxy, "proxy == null"));
        return this;
    }
    ...
    public NetGlobalConfig connectTimeout(int timeout, TimeUnit unit) {
        if (timeout > -1) {
            RxNet.getOkHttpBuilder().connectTimeout(timeout, unit);
        } else {
            RxNet.getOkHttpBuilder().connectTimeout(FrameworkConfig.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
        }
        return this;
    }
    ...
    public NetGlobalConfig writeTimeout(int timeout, TimeUnit unit) {
        if (timeout > -1) {
            RxNet.getOkHttpBuilder().writeTimeout(timeout, unit);
        } else {
            RxNet.getOkHttpBuilder().writeTimeout(FrameworkConfig.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
        }
        return this;
    }
    ...
    public NetGlobalConfig readTimeout(int timeout, TimeUnit unit) {
        if (timeout > -1) {
            RxNet.getOkHttpBuilder().readTimeout(timeout, unit);
        } else {
            RxNet.getOkHttpBuilder().readTimeout(FrameworkConfig.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
        }
        return this;
    }
    ...
    public NetGlobalConfig interceptor(Interceptor interceptor) {
        RxNet.getOkHttpBuilder().addInterceptor(checkNotNull(interceptor, "interceptor == null"));
        return this;
    }
    ...
    public NetGlobalConfig networkInterceptor(Interceptor interceptor) {
        RxNet.getOkHttpBuilder().addNetworkInterceptor(checkNotNull(interceptor, "interceptor == null"));
        return this;
    }
    ...
    public NetGlobalConfig cacheOffline(Cache httpCache) {
        networkInterceptor(new OfflineCacheInterceptor(RxNet.getContext()));
        interceptor(new OfflineCacheInterceptor(RxNet.getContext()));
        this.httpCache = httpCache;
        return this;
    }
    ...
    public NetGlobalConfig cacheOffline(Cache httpCache, final int cacheControlValue) {
        networkInterceptor(new OfflineCacheInterceptor(RxNet.getContext(), cacheControlValue));
        interceptor(new OfflineCacheInterceptor(RxNet.getContext(), cacheControlValue));
        this.httpCache = httpCache;
        return this;
    }
