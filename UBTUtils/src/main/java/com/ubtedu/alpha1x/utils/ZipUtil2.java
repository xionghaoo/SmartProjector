...
public class ZipUtil2 {
    ...
    public static boolean zipFile(String resFilePath, String zipFilePath, String comment)
            throws IOException {
        return zipFile(resFilePath == null ? null : new File(resFilePath),
                zipFilePath == null ? null : new File(zipFilePath), comment);
    }
     ...
     * @param outZipFilePath    :压缩后存放路径
     * @return
     */
    public static boolean zip(String srcFilePath, String outZipFilePath) {
