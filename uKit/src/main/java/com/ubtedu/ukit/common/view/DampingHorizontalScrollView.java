 ...
 * @Date 2018/12/6
 **/
public class DampingHorizontalScrollView extends HorizontalScrollView {
    private View inner;

    public DampingHorizontalScrollView(Context context) {
        this(context,null);
    }

    public DampingHorizontalScrollView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DampingHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
