 ...
 * @Date 2018-11-29
 **/
public class Joystick2DirectionViewH extends ControllerWidgetView<Joystick2DirectionHConfig> implements SeekBar.OnSeekBarChangeListener {
    ...
    public Joystick2DirectionViewH(Context context) {
        this(context, null);
    }

    public Joystick2DirectionViewH(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initJoystick2DirectionViewH();
    }

    private void initJoystick2DirectionViewH() {
        View view = inflateView(R.layout.item_project_controller_joystick_2direction_horizontal);
    ...
    public void setWidgetName(String widgetName) {
        Joystick2DirectionHConfig config = getWidgetConfig();
    ...
    @Override
    protected Joystick2DirectionHConfig newConfig() {
        return new Joystick2DirectionHConfig();
    }

    @Override
    protected WidgetType getType() {
        return WidgetType.WIDGET_UKTWOWAYJOYSTICKH;
    }

    @Override
    protected void applyConfig(Joystick2DirectionHConfig config) {
