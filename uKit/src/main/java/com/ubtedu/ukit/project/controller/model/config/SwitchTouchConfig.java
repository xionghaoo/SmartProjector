 ...
 * @Date 2018-12-03
 **/
public class SwitchTouchConfig extends WidgetConfig {
	
	{
		type = WidgetType.WIDGET_UKTOUCHSWITCH.getWidgetName();
		name = WidgetType.WIDGET_UKTOUCHSWITCH.getDefaultName();
		mode = -1;
	}
